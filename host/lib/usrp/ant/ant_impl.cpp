...
void ant_impl::setup_radio(const size_t dspno)
{
    ...
    // Set up peripherals
    ////////////////////////////////////////////////////////////////////
    const auto atr_offsets = gpio_atr_offsets::make_write_only(TOREG(SR_ATR));
    perif.atr             = gpio_atr_3000::make(perif.ctrl, atr_offsets);
